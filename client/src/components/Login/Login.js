        ...
        <>
            <Box style={{ margin: "auto", marginTop: "1rem", width: "100%" }}>
                <form action="" style={{ margin: "auto", marginBottom: "15px", width: "60%", padding: "1rem", boxShadow: "1px 1px 10px 1px black", borderRadius: "8px" }} >
                    ...
                    <Button variant="contained" type='submit' color="success" style={{ width: "100%", padding: "1rem", fontSize: "1rem", marginTop: "15px" }}>Login</Button>
                    <Button variant="outlined" color="error" style={{ width: "100%", padding: "1rem", fontSize: "1rem", marginTop: "15px" }}>ALREADY REGISTERED</Button>
                </form>
            </Box>
        </>
    );
